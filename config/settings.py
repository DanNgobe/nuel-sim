...
# Available options: "TargetStrongest", "TargetWeaker", "TargetStronger", "TargetRandom", "TargetNearest", "RLlibStrategy", "TargetBelievedStrongest"
ASSIGNED_STRATEGY_TYPES = ["TargetRandom"] * NUM_PLAYERS
ASSIGNED_ACCURACIES = []
